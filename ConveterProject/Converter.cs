...
namespace Project2
{
    internal class Program
    {
        ...
        static string[] menu = new string[] { "[1] Length", "[2] Time", "[3] Mass", "[4] Temperature", "[5] Data", "[6] Exit" };
        ...
        static void GetAmountInput()
        {
            ...
            ConverterProcess.MetertoCm(userInput, conversionInput, amountInput, ConverterProcess.preamount);
